<link rel="stylesheet" href="/assets/css/manageNotice02.css" type="text/css">
    <div id="head_img">
    	<div class="head_img_inner">
			<div class="head_text">
				<p class="maintitle">AVDS Inquiry List</p>
                <p class="sub_text"></p>
			</div>
        </div>   
    </div>
    ...
    <div id="container1">
        <div class="container1_inner">
            <div class="title">
                <div class="s_title">Inquiries</div>
                <div class="line"></div>
            </div>
                          ...
                          <td height="70" align="center"><table width="940" border="0" cellspacing="0" cellpadding="0">
                            <tr>
				              ...
				              <td align="center" bgcolor="#FFFFFF" class="r03">
				            	<a style="backgrond-color:#fff;" class="r03 admin_inquiry_edit" inquiry_id="<?=$id?>" >Edit</a>
				              </td>
				              <td align="center" bgcolor="#FFFFFF" class="bl04">
				             	<a style="backgrond-color:#fff;" class="bl04 admin_inquiry_delete" inquiry_id="<?=$id?>">Del</a>
				              </td>
                            </tr>
                          </table></td>
                        </tr>  
...
<form method="post" action="/Manage/save_inquiry_modified" id="inquiry_modify_form" name="inquiry_modify_form">
<table width="800" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr>
      <td align="center" bgcolor="#FFFFFF"><table width="370" border="0" cellspacing="0" cellpadding="0">
      	  ...
      	  <tr>
            <td height="30" class="gr03" align="left" style="display:-webkit-box;"><strong><span>ID :&nbsp;&nbsp;<div id="edit_inquiry_id"></span></strong> </div></td>
          </tr>
      	  
      	  <tr>
            <td height="30" class="gr03" align="left"><strong><span>Title :</span></strong>   <input type="textarea" id="edit_inquiry_title" name="edit_rel_title" style="width:730px"></td>
          </tr>
          ...
          <tr>
            <td>
              <textarea name="edit_rel_content" id="edit_inquiry_content" cols="45" rows="5" style="width:780px; height:450px; padding-left:15px; padding-top:12px; color:#999999; border: 0px; background-color:#f2f2f2; font-family:arial; font-size:13px;"></textarea>
            </td>
          </tr>
      </table></td>
    </tr>
